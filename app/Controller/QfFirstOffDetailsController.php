...
class QfFirstOffDetailsController extends AppController {
    ...
    public function edit($itemId = null) {
        ...
        if ($this->request->is(array('post', 'put'))) {
            ...
            //log//
            $this->loadModel('Log');
            $oldData = $this->QfFirstOffDetail->findById($this->request->data['QfFirstOffDetail']['id']);
            ////////

            if ($this->QfFirstOffDetail->save($this->request->data)) {
                
                //log//
                $this->Log->saveLog(array('model' => 'QfFirstOffDetail', 'oldData' => $oldData, 'session' => $this->Session->read('Auth.User')));
                /////////
