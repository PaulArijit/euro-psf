...
class FussetSpecificationsController extends AppController {
    ...
    public function edit($itemId = null) {
        ...
        if ($this->request->is(array('post', 'put'))) {
            ...
            if (!empty($this->request->data['FussetSpecification']['additional_information']['name'])) {
                move_uploaded_file($this->data['FussetSpecification']['additional_information']['tmp_name'], $uploaddir . $this->data['FussetSpecification']['additional_information']['name']);
                $this->request->data['FussetSpecification']['additional_information'] = $this->request->data['FussetSpecification']['additional_information']['name'];
            } else {
                unset($this->request->data['FussetSpecification']['additional_information']);
            }
