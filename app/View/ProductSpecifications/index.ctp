<div class="row">
    <div class="col-xs-12">
        <div class="card" id="list-items">
            ...
            <div class="card-body">
                <?php $url = array('controller' => 'ProductSpecifications', 'action' => 'index'); ?>
                ...
                <table class="search-tab" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td style="text-align: center;">
                            <?php
                            echo $this->Form->input('thickness', array(
                                'type' => 'checkbox', 'label' => 'Thickness'));
                            ?>
                        </td>
                        <td class="min">
<?php echo $this->Form->input('thickness_min', array('label' => false, 'class' => 'form-control input-sm')); ?>
                        </td>
                        <td class="max"><?php echo $this->Form->input('thickness_max', array('label' => false, 'class' => 'form-control input-sm')); ?></td>
                    </tr>
                    <tr>
                        <td style="text-align: center;">
                            <?php
                            echo $this->Form->input('closedwidth', array(
                                'type' => 'checkbox', 'label' => 'Closed Width'));
                            ?>
                        </td>
                        <td class="min"><?php echo $this->Form->input('closedwidth_min', array('label' => false, 'class' => 'form-control input-sm')); ?></td>
                        <td class="max"><?php echo $this->Form->input('closedwidth_max', array('label' => false, 'class' => 'form-control input-sm')); ?></td>
                    </tr>
                    <tr>
                        <td style="text-align: center;">
                            <?php
                            echo $this->Form->input('openwidth', array(
                                'type' => 'checkbox', 'label' => 'Open Width'));
                            ?>
                        </td>
                        <td class="min">
...
<?php echo $this->Form->input('openwidth_max', array('label' => false, 'class' => 'form-control input-sm')); ?>
                    ...
                    <tr>
                        <td style="text-align: center;">
                            <?php
                            echo $this->Form->input('baglength', array(
                                'type' => 'checkbox', 'label' => 'Bag Length'));
                            ?>
                        </td>
                        <td class="min">
<?php echo $this->Form->input('baglength_min', array('label' => false, 'class' => 'form-control input-sm')); ?>
                        </td>
                        <td class="max">
<?php echo $this->Form->input('baglength_max', array('label' => false, 'class' => 'form-control input-sm')); ?>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2"></td>
                        <td style="text-align: right;"><button type="submit" class="btn  btn-info"><i class="fa fa-search"></i> Search</button>  <?php echo $this->Html->link('<i class="fa fa-refresh"></i>', array('action' => 'index'), array('escape' => FALSE, 'class' =>'btn btn-warning')); ?></td>
                    </tr>
                </table>
                <br/>
                <h1>Search Result</h1>
                <table class="search-tab">
                    <tr>
                        ...
                        <tr>
                            <td class='link-td'>
    <?php echo $this->Html->link($productSpecification['Item']['description'], array('controller' => 'items', 'action' => 'edit', $productSpecification['Item']['id'])); ?>
                            </td>
