...
<h2><?php echo __('Log'); ?></h2>
	<dl>
		...
		<dd>
			<?php echo h($log['Log']['table_name']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Field Name'); ?></dt>
		<dd>
			<?php echo h($log['Log']['field_name']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Old Data'); ?></dt>
		<dd>
			<?php echo h($log['Log']['old_data']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('New Data'); ?></dt>
		<dd>
			<?php echo h($log['Log']['new_data']); ?>
			&nbsp;
		</dd>
