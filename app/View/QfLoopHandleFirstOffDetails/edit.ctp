            ...
            <div class="card-body no-padding">               
                <div role="tabpanel">
                    ...
                    <div class="tab-content">
                        <div class="row">
                            ...
                            <div class="col-lg-4 text-right">
                                <?php if ($this->Session->read('Auth.User.role') == 100) { ?>
                                    <a id="editForm" href="javascript:void(0)" style="font-size:18px; color: #ff9900" title="Edit Form" ><i class="fa fa-edit"></i> Edit Loop Handle First Off Details</a>
                        ...
                        <div class="row">
                            <?php echo $this->Form->create('QfLoopHandleFirstOffDetail', array('enctype' => 'multipart/form-data')); ?>
                            <?php echo $this->Form->input('id'); ?>
                            <?php echo $this->Form->input('item_id', array('type' => 'hidden')); ?>
                            <h1 class="text-center">Loop Handle First Off Dfs</h1>
                            <div class="col-lg-12">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="panel fresh-color panel-default">                                    
                                    <div style="height: 415px;" class="panel-body text-center">
                                        <?php
                                        if ($this->request->data['QfLoopHandleFirstOffDetail']['artwork_detail'] == '') {
                                            echo 'No preview available';
                                        } else {
                                            echo '<img src="' . SITE_URL . $imgdirPath . $this->request->data['QfLoopHandleFirstOffDetail']['artwork_detail'] . '" width="1000" height="370">';
                                        }
                                        ?>
                                    </div>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="panel fresh-color panel-default">                                    
                                    <div style="height: 215px;" class="panel-body text-center">
                                        <?php
                                        if ($this->request->data['QfLoopHandleFirstOffDetail']['sample_bag_attachment'] == '') {
                                            echo 'No preview available';
                                        } else {
                                            echo '<img src="' . SITE_URL . $imgdirPath . $this->request->data['QfLoopHandleFirstOffDetail']['sample_bag_attachment'] . '" width="400" height="180">';
                                        }
                                        ?>
                                    </div>
                                    <div class="panel-footer text-center">
...
<div id="ext-first-off-print" class="print-hidden">
    <center>
        <table>
            <tr>
                <td width="90%" style="text-align: center;"><h2>LoopHandle First Off DFS</h2></td>
            ...
            <div class="panel fresh-color panel-default">                                    
                <div style="height: 215px; border: 1px solid silver; padding: 5px;" class="panel-body text-center">
                    ...
                    if ($this->request->data['QfLoopHandleFirstOffDetail']['artwork_detail'] == '') {
                        ...
                        echo '<img src="' . SITE_URL . $imgdirPath . $this->request->data['QfLoopHandleFirstOffDetail']['artwork_detail'] . '" width="90%" height="200">';
                    }
                    ?>
                </div>                
            </div>
                ...
                <div class="panel fresh-color panel-default">                                    
                    <div style="height: 115px; border: 0px solid silver; padding: 5px;" class="panel-body text-center">
                        ...
                        if ($this->request->data['QfLoopHandleFirstOffDetail']['sample_bag_attachment'] == '') {
                            ...
                            echo '<img src="' . SITE_URL . $imgdirPath . $this->request->data['QfLoopHandleFirstOffDetail']['sample_bag_attachment'] . '" width="300" height="100">';
                        }
                        ?>
                    </div>                   
                </div>                                
...
<!--<div class="qfLoopHandleFirstOffDetails form">
<?php echo $this->Form->create('QfLoopHandleFirstOffDetail'); ?>
	<fieldset>
		<legend><?php echo __('Edit Qf Loop Handle First Off Detail'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('QfLoopHandleFirstOffDetail.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('QfLoopHandleFirstOffDetail.id'))); ?></li>
		<li><?php echo $this->Html->link(__('List Qf Loop Handle First Off Details'), array('action' => 'index')); ?></li>
