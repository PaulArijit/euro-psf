            ...
            <div class="card-body no-padding">               
                <div role="tabpanel">
                    ...
                    <div class="tab-content">
                        <div class="row">
                            ...
                            <div class="col-lg-4 text-right">
                                <?php if ($this->Session->read('Auth.User.role') == 100) { ?>
                                    <a id="editForm" href="javascript:void(0)" style="font-size:18px; color: #ff9900" title="Edit Form" ><i class="fa fa-edit"></i> Edit Layer Pad Specification</a>
                        ...
                        <div class="row">
                            <?php echo $this->Form->create('LayerPadSpecification', array('enctype' => 'multipart/form-data')); ?>
                            <?php echo $this->Form->input('id'); ?>
                            <?php echo $this->Form->input('item_id', array('type' => 'hidden')); ?>
                            <h1 class="text-center">Layer Pad</h1>
                            <div class="col-lg-10">
                                <div class="panel panel-default">
                                    <div class="panel-body">
                                        <dl>
                                    ...
                                    <tr>
                                        ...
                                        <td style="height: 200px; vertical-align: top">
                                            <p style="height: 180px;"><?php
                                                if ($this->request->data['LayerPadSpecification']['additional_information'] == '') {
                                                    echo 'No preview available';
                                                } else {
                                                    echo '<img src="' . SITE_URL . $imgdirPath . $this->request->data['LayerPadSpecification']['additional_information'] . '" width="300" height="200">';
                                                }
                                                ?>
                                            </p>
...
<div id="ctn-print" class="print-hidden">
    <center>
        <table>
            <tr>
                <td width="90%" style="text-align: center;"><h2>Layer Pad Specification</h2></td>
...
<!--<div class="layerPadSpecifications form">
<?php echo $this->Form->create('LayerPadSpecification'); ?>
	<fieldset>
		<legend><?php echo __('Edit Layer Pad Specification'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('LayerPadSpecification.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('LayerPadSpecification.id'))); ?></li>
